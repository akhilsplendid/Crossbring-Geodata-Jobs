...
.PHONY: up down logs psql init-db analytics-sql fetch-af load-csv map status smoke demo-csv demo-af dashboard dash-up dash-down dash-logs
...
dash-down:
	$(DC) -f docker-compose.yml stop dashboard
